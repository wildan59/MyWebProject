...
WebUI.setText(findTestObject('SecondHand Website/02. Login/input_field_email'), GlobalVariable.ValidUser_Buyer)

WebUI.setText(findTestObject('SecondHand Website/02. Login/input_field_password'), GlobalVariable.InvalidPassword_Buyer)
