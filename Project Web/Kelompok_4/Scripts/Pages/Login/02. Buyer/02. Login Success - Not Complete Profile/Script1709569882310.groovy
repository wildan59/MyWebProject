...
WebUI.setText(findTestObject('SecondHand Website/Login/input_field_email'), GlobalVariable.validUser)

WebUI.setText(findTestObject('SecondHand Website/Login/input_field_password'), GlobalVariable.validPassword)
