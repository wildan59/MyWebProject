...
WebUI.setText(findTestObject('SecondHand Website/02. Login/input_field_email'), GlobalVariable.InvalidUser_Seller)

WebUI.setText(findTestObject('SecondHand Website/02. Login/input_field_password'), GlobalVariable.ValidPassword_Seller)
