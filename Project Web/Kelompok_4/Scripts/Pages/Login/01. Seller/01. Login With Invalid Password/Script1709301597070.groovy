...
WebUI.setText(findTestObject('SecondHand Website/Login/input_field_email'), GlobalVariable.ValidUser_Seller)

WebUI.setText(findTestObject('SecondHand Website/Login/input_field_password'), GlobalVariable.InvalidPassword_Seller)
