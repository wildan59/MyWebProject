...
WebUI.callTestCase(findTestCase('Pages/Login/02. Buyer/02. Login Success - Not Complete Profile'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Complete Profile Page/Lengkapi Info Akun'), [:], FailureHandling.STOP_ON_FAILURE)
