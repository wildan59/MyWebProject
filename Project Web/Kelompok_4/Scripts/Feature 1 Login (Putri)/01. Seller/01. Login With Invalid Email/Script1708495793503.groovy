...
WebUI.setText(findTestObject('SecondHand Website/02. Login/login-input_Email'), GlobalVariable.InvalidUser_Seller)

WebUI.setText(findTestObject('SecondHand Website/02. Login/login-input_Password'), GlobalVariable.ValidPassword_Seller)
